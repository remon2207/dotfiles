...
main() {
  local -r nfs_opts='nfs rw,async,nodev,nosuid,noexec,noatime,nofail,noauto,nomand,noiversion,norelatime,_netdev,lazytime,x-systemd.automount,x-systemd.idle-timeout=1min 0 0'
