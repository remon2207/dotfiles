...
# /mnt/linux-windows
PARTUUID=fe32ec92-a0c4-4aa8-ad27-a562129f1f04 /mnt/linux-windows ntfs-3g uid=1000,gid=1000,dmask=022,fmask=133,nodev,nosuid,noatime,noexec,nofail,noauto,nomand,noiversion,norelatime,lazytime,x-systemd.automount,x-systemd.idle-timeout=1min 0 0
